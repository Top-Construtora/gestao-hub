  ...
  async duplicate(id, duplicateData, userId) {
    try {
      ...
      const newServiceData = {
        ...
        subtitle: duplicateData.subtitle !== undefined ? duplicateData.subtitle : originalService.subtitle,
        summary: duplicateData.summary !== undefined ? duplicateData.summary : originalService.summary
      };
